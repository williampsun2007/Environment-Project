...
for i, pollutant in enumerate(["SO2", "NOx", "VOC", "NH3", "PM2.55", "PM10", "BC", "OC"]):
    axes[i][0].set_ylabel(f"Percentage (%)")
for i in range(5):
...
plt.tight_layout()
plt.savefig(r"C:\Users\sunyi\Environment_Project\Emission Excel Files\Stacked_Bar_Chart_Percentage.png", bbox_inches="tight")
plt.show()