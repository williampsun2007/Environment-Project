...
wb = openpyxl.load_workbook("on-time_peak-net_zero-clean_air/2020_2035_change_percentage.xlsx")
...
for group in groups:
    ...
    for weather_year in range(2017, 2025):
        file_name = f"EmissionReductions_OTPNZCA2035_{binary_code}_{weather_year}Met"
        wb_edit.save(f"Species Combination Test Excel Files/OTPNZCA/{file_name}-2020-{weather_year}.xlsx")