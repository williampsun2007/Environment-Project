...
for scenario in ["Baseline", "CleanAir", "OTPCA", "OTPNZCA", "EPNZCA"]:
    ...
    df_scenario_2020 = pd.read_excel(f"{scenario}_All_Years/{scenario_full_name}_2020_Emission.xlsx", sheet_name = "PM25")
    df_scenario_2035 = pd.read_excel(f"{scenario}_All_Years/{scenario_full_name}_2035_Emission.xlsx", sheet_name = "PM25")
    ...
    df_merged.to_excel(f"5 Scenarios Per Capita/{scenario_full_name}_Per_Capita.xlsx", index = False)
